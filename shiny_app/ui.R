  ...
  #   # Output: Tabset w/ plot, summary, and table ----
      tabsetPanel(type = "tabs",
                  tabPanel("PCA", 
                           ...
                           fluidRow(downloadLink("downloadPlot", "Download Plot")),
                           fluidRow(downloadLink("downloadData", "Download Data")),
                  ...
                  tabPanel("t-SNE",  
                           ...
                           fluidRow(downloadLink("downloadPlot2", "Download Plot")),
                           fluidRow(downloadLink("downloadData2", "Download Data"))
                           ),
                  tabPanel("Clustering",
                           withLoader(
                   plotlyOutput("Clustering",height = "1200px", width = "100%")),
                   fluidRow(downloadLink("downloadPlot3", "Download Plot")),
                   fluidRow(downloadLink("downloadData3", "Download Data")),
                   ...
                   fluidRow(downloadLink("downloadData7", "Download Data")),
                 ...
                 tabPanel("Sholl",
                          ...
                          fluidRow(downloadLink("downloadData8", "Download Data")),
                          fluidRow(splitLayout(style = "border: 1px solid silver:", cellWidths = c("40%","40%"),
                          ...
                          fluidRow(splitLayout(style = "border: 1px solid silver:", cellWidths = c("40%","40%"),
                                               downloadLink("downloadData9", "Download Data"),
                                               downloadLink("downloadData10", "Download Data")))),
                 ...
                 tabPanel("Distances",
                          ...
                          fluidRow(downloadLink("downloadPlot6", "Download Plot")),
                          fluidRow(downloadLink("downloadData6", "Download Data")))
      )
    ),
    column(1),
    column(2,
